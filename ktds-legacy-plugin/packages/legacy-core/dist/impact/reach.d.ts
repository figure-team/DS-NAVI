 ...
 */
export declare function buildAdjacency(edges: readonly EdgeRecord[], allowedKinds: ReadonlySet<EdgeKind>, direction: ReachDirection): Map<string, AdjEntry[]>;
/**
 ...
 */
export declare function reachClosure(seeds: readonly string[], adjacency: Map<string, AdjEntry[]>, depthCap: number): ReachedFile[];
/**
 ...
 */
export declare function computeFanIn(edges: readonly EdgeRecord[], allowedKinds: ReadonlySet<EdgeKind>): Map<string, number>;
