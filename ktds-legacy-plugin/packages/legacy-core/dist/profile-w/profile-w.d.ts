 ...
 */
export declare const ProfileWTaskSchema: z.ZodObject<{
    id: z.ZodString;
    description: z.ZodString;
    fileList: z.ZodOptional<z.ZodArray<z.ZodString>>;
}, z.core.$strip>;
 ...
 */
export declare const ProfileWChangeStorySchema: z.ZodObject<{
    storyId: z.ZodString;
    title: z.ZodString;
    ...
    sourceCitations: z.ZodArray<z.ZodObject<{
        file: z.ZodString;
        line: z.ZodNullable<z.ZodNumber>;
    }, z.core.$strip>>;
    fileList: z.ZodArray<z.ZodString>;
}, z.core.$strip>;
export type ProfileWChangeStory = z.infer<typeof ProfileWChangeStorySchema>;
//# sourceMappingURL=profile-w.d.ts.map