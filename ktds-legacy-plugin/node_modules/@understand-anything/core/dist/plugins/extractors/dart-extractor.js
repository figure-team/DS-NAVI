...
export class DartExtractor {
    ...
    extractExtensionDeclaration(declNode, classes, functions, exports) {
        ...
        if (idNode) {
            this.extractClassLikeDeclaration(declNode, "extension_body", classes, functions, exports);
            return;
        }
        ...
        if (!onType)
            return;
        this.extractClassLikeDeclaration(declNode, "extension_body", classes, functions, exports, `on ${onType.text}`);
    }
...
//# sourceMappingURL=dart-extractor.js.map