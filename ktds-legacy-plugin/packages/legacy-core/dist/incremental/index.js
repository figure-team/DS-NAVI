...
export function computeFileFingerprints(projectRoot, census) {
    const out = {};
...
export function isUnchanged(diff) {
 ...
 */
export function anchorFingerprints(doc, fileFingerprints) {
    const out = {};
