export const en = {
  ...
  domainMap: {
    ...
    subtitle:
      "Start here when you inherit a codebase. Pick a domain to trace its core flows across every layer boundary on one screen.",
    statDomains: "Domains",
    statFlows: "Flows (entry points)",
  ...
  flowList: {
    ...
    selectPrompt: "Select a flow to view its cross-layer graph.",
