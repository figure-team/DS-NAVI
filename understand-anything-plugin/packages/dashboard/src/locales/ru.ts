export const ru = {
  ...
  detailLevel: {
    overview: "Обзор",
    overviewTitle: "Обзор — скрывает функции и классы, только высокоуровневая архитектура",
  ...
  impactAnalyze: {
    button: "Анализ влияния",
    buttonTitle: "Запустить анализ влияния изменений на естественном языке",
