...
export function bareIdent(raw: string): string {
...
export function matchParen(source: string, openIdx: number): number {
  let depth = 0
  let inStr = false
...
export function parenIdentList(inner: string): string[] {
