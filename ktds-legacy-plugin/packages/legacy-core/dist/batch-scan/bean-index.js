 ...
 */
export function beanBodyRange(text, openEnd) {
...
export function blankNestedBeans(body) {
    let result = body;
...
export function collectBeans(rawText, relPath, out) {
...
export function buildSpringBeanIndex(projectRoot, census) {
    const out = new Map();
 ...
 */
export function classFqnToFile(fqn, census) {
...
//# sourceMappingURL=bean-index.js.map