export const ko = {
  ...
  domainMap: {
    ...
    empty: "도메인 그래프가 없습니다. CLI에서 /understand-domain을 실행해 먼저 생성하세요.",
    breadcrumbRoot: "도메인",
    ...
    extBatch: "배치 · 스케줄",
    extNone: "없음 — 스캔 완료",
    extUnavailable: "연동 데이터 없음 — CLI에서 /understand-map scan을 실행해 먼저 생성하세요",
  ...
  groupWorkspace: {
    navTitle: "하위 도메인",
    searchPlaceholder: "하위 도메인·업무 흐름 검색",
    noFlows: "업무 흐름 없음",
  },
  structure: {
    menuTitle: "그래프",
    root: "그래프",
    breadcrumbLabel: "그래프 브레드크럼",
    crossDomainUnavailable: "의존 데이터 없음 — CLI에서 /understand-map scan을 실행해 먼저 생성하세요",
    noCrossGroupEdges: "교차 도메인 의존 없음",
    evidenceTitle: "의존 근거",
    evidenceWeight: "파일 관계 {count}건",
    evidenceClose: "닫기",
    evidenceMore: "+{count}건",
    bfNodeCount: "노드 {count}개",
    sequentialFallbackCard: "순차 근사 (전체 기능)",
    backToProcessList: "업무 프로세스 목록으로",
    relatedFlowSpine: "관련 기능흐름도",
    chipSubDomains: "하위 도메인",
    nodeInfoTitle: "노드 정보",
  },
  flowView: {
    selectedFlow: "선택된 기능",
    ...
    steps: [
      {
        ...
        body: "레거시 시스템 인수분석 대시보드입니다. 홈에서 프로젝트 요약과 규모를 확인하고, 카드를 눌러 도메인·추적표·산출물 각 여정으로 들어갑니다.",
        hint: "5단계로 핵심 화면을 살펴봅니다",
      },
      {
        title: "좌측 내비게이션 — 모든 화면은 URL",
        body: "도메인(업무 구성과 그래프), 추적표(요구사항 RTM), 산출물(SI 문서)로 이동합니다. 모든 화면과 선택 상태는 주소에 담기므로, 주소를 복사해 붙이면 같은 화면이 그대로 열립니다.",
        hint: "새로고침·뒤로가기·링크 공유가 전부 동작합니다",
      },
      {
        title: "도메인 여정 — 지도에서 흐름까지",
        body: "구성 탭에서 업무 영역을 고르면 기능 흐름 목록이, 흐름을 고르면 API→Service→DAO→DB 교차계층 스파인이 열립니다. 근거율과 인용 칩으로 모든 서술의 코드 근거를 확인할 수 있습니다.",
      ...
      {
        title: "더 있는 것들",
        body: "그래프 탭 툴바에는 필터·내보내기·경로 찾기가, 상단 바에는 테마 전환과 도움말이 있습니다. Shift + ?를 누르면 전체 키보드 단축키를 볼 수 있습니다.",
