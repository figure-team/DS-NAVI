...
/** (method, path) 자연키. */
export function routeNaturalKey(method, path) {
    return `${method} ${path}`;
}
/**
 * routeId 를 할당한다.
 ...
 */
export function assignRouteIds(routes) {
...
export function sortRoutes(routes) {
    return [...routes].sort((a, b) => cmp(a.path, b.path) ||
...
export function sortBatchEntries(entries) {
    return [...entries].sort((a, b) => cmp(a.filePath, b.filePath) || cmp(a.line, b.line) || cmp(a.entryId, b.entryId));
}
//# sourceMappingURL=route-key.js.map