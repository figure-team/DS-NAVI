import { classFqnToFile } from './bean-index.js';
...
function beanToJobClass(beanId, beans) {
 ...
 */
export function resolveBatchHandlers(entries, beans, census) {
    return entries.map((e) => {
        if (JAVA_TRIGGERS.has(e.trigger))
            return { ...e, handlerFile: e.filePath };
