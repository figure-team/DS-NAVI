export const ru = {
  ...
  domainMap: {
    ...
    subtitle:
      "Начните отсюда, принимая кодовую базу. Выберите домен, чтобы проследить его ключевые потоки через все границы слоёв на одном экране.",
    statDomains: "Домены",
    statFlows: "Потоки (точки входа)",
    statNodes: "Проанализировано узлов",
    flowCount: "Потоков: {count}",
  ...
  flowList: {
    ...
    selectPrompt: "Выберите поток, чтобы увидеть его межслойный граф.",
