export const zhTW = {
  ...
  impactAnalyze: {
    title: "自然語言影響探索",
    description:
      "用自然語言描述你打算進行的變更。系統會先提出種子候選，僅對你確認的種子執行分析。結果會記錄在變更影響選單（以及結構圖疊加層）。",
    intakeHint: "這是探索性分析 — 正式的需求受理與需求分解請前往 追蹤表 → 請求工作階段。",
    placeholder: "例如：我想新增 Kakao 社群登入",
    run: "提議種子候選",
    submitting: "正在啟動…",
    cancel: "取消",
    running: "正在探索影響",
    runningHint: "影響探索進行中 — 點擊查看",
    alreadyRunning: "已有分析正在進行。完成後請重試。",
    errNoServer: "無法執行分析：不是可寫入的開發伺服器。",
    errGeneric: "啟動分析失敗。",
    modelDefault: "工作階段模型（預設）",
    modelAria: "選擇分析模型",
    toastDone: "影響分析完成 — 結果已記錄在變更影響選單。",
    toastFailed: "影響分析失敗。請查看主控台/日誌。",
    candidatesTitle: "確認種子候選",
    candidatesDesc: "針對你的查詢提出的種子候選。請確認要分析的檔案 — 種子由你決定，而不是模型。",
    candidatesEmpty: "沒有提出候選。請調整查詢或手動新增路徑。",
    candidatesLoadFailed: "載入種子候選失敗。",
    candidatesFor: "查詢",
    addPathPlaceholder: "手動新增：專案相對路徑",
    addPath: "新增",
    analyzeRun: "用這些種子分析",
    newQuery: "新查詢",
    toastCandidates: "種子候選已就緒 — 確認後即開始分析。",
  },
  layer: {
    defaultName: "層級",
    label: "層",
  ...
  onboarding: {
    ...
    steps: [
      ...
      {
        title: "更多隱藏功能",
        body: "頂欄還有 Filter（按類型 / 複雜度過濾）、Export（匯出圖）、Path（找兩個節點之間的路徑）、Theme（切換主題）。",
        hint: "需要時再展開，不要一次記完",
      },
    ],
  },
