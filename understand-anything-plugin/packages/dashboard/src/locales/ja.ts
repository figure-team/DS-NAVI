export const ja = {
  ...
  domainMap: {
    ...
    title: "業務ドメインマップ",
    subtitle:
      "コードベースを引き継いだら、まずここから。各ドメインを選択すると、コア フローをレイヤー境界を越えて1画面で追跡できます。",
    statDomains: "ドメイン",
    statFlows: "フロー（エントリーポイント）",
    statNodes: "解析済みノード",
    flowCount: "フロー {count}件",
  ...
  flowList: {
    ...
    back: "← ドメインマップ",
    fullscreen: "⤢ 全画面",
    selectPrompt: "フローを選択すると、クロスレイヤーグラフが表示されます。",
